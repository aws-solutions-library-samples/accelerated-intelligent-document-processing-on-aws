...
def test_required_arg_count_is_stable(spec):
    ...
    visible in the diff (104 fields require a non-null arg as of this spec — the
    ...
    resetTestSetLabels the 101st, generateRuleJson the 102nd, and the
    page-regrouping pair updateTestSetDocumentSections/updateDocumentSections
    103–104)."""
    required = [
