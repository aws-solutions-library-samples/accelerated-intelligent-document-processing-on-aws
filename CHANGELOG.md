...
- **Amazon Nova Premier is documented as unusable.** Every call to `us.amazon.nova-premier-v1:0` returns `ResourceNotFoundException: This model version has reached the end of its life`, including a trivial baseline request, while the model remains selectable in the extraction dropdown.
