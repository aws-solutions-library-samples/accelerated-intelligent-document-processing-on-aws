...
- **Deterministic type/format coercion** for extraction output (`idp_common.extraction.coercion`) — currency and thousands separators in both conventions, named-month and unambiguous numeric dates, boolean-ish strings — recording every change and refusing anything genuinely ambiguous (`01/02/2024`, 2-digit years, fractional-to-integer). Not yet wired into the pipeline.
