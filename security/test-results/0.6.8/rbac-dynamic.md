...
- **Checks:** 604 (603 passed, 0 hard fail, 1 known-gap warning)
- **Ran against:** stack `<REDACTED>` in region `us-west-2` (account `<ACCOUNT_ID>`)
- **Source git SHA:** `d584958e0`
...
| Unauthenticated access denied | 1 | 115 | 115 | 0 ✅ | 0 |
...
| Authorization matrix (positive: role allowed) | 2/2.2 | 460 | 460 | 0 ✅ | 0 |
| Config-version scope enforcement | 2/2.2 | 7 | 7 | 0 ✅ | 0 |
