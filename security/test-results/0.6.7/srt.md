...
- **CI-visible findings:** 17729
- **Source:** live scan results (`.srt/issues.json`) — 341 git-ignored finding(s) excluded to match the CI view
...
|----------|----------|---------:|-----:|
| Bandit | Python SAST | 17255 | 54 |
| Checkov | IaC / CloudFormation misconfig | 267 | 2 |
| Semgrep | multi-language SAST | 154 | 1 |
...
|----------|------:|------:|------:|------:|------:|
| HIGH | 0 | 0 | 60 | 44 | 104 |
| MEDIUM | 68 | 0 | 62 | 0 | 130 |
| LOW | 14354 | 65 | 3065 | 0 | 17484 |
| INFO | 10 | 0 | 1 | 0 | 11 |
...
| security-matrix | `DDB-002` | 0 | 0 | 1 | 19 |
| security-matrix | `EC2-002` | 0 | 0 | 0 | 3 |
| security-matrix | `IAM-009` | 0 | 0 | 0 | 1 |
| security-matrix | `KMS-007` | 0 | 0 | 0 | 6 |
| security-matrix | `LAMBDA-004` | 0 | 0 | 0 | 1 |
| security-matrix | `LAMBDA-005` | 0 | 0 | 0 | 1 |
| security-matrix | `LAMBDA-011` | 0 | 0 | 0 | 1 |
| security-matrix | `LAMBDA-012` | 0 | 0 | 2 | 0 |
