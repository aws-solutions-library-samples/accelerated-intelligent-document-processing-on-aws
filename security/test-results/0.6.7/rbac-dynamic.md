...
- **Checks:** 596 (595 passed, 0 hard fail, 1 known-gap warning)
- **Ran against:** stack `<REDACTED>` in region `us-west-2` (account `<ACCOUNT_ID>`)
- **Source git SHA:** `843768c6c`
...
| Unauthenticated access denied | 1 | 114 | 114 | 0 ✅ | 0 |
...
| Authorization matrix (positive: role allowed) | 2/2.2 | 456 | 456 | 0 ✅ | 0 |
...
## Authorization matrix — 114 operations × 5 roles

<details><summary>Full op × role matrix (570 checks) — HTTP status, ✅ pass / ❌ fail</summary>
