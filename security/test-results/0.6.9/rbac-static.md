...
=== Static API RBAC scan ===
  ...
  ⚠ [GAP] GAP-07: the chat Function URL transport carries no Cognito group claim, so the agent-chat group check cannot be applied to callers arriving that way
 — affects: POST /chat/agent
