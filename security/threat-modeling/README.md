...
**five** scope-aware resolvers still read one as "unrestricted"; the scope is keyed
on an email that can diverge from the row it should match; nothing constrains which
identifier a claims set yields; and Chat-with-Document is unrestricted on the
