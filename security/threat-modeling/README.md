...
| UI.T06 | Object reads are not scoped per **document**; the two per-user scope axes are enforced on the key, document ownership is not modelled | **issue #1033** (pending) | [web-ui.md](feature-threats/web-ui.md) |
