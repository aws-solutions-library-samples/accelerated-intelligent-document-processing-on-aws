...
| UI.T06 | Presigned read URLs are bucket-scoped, not key-scoped; the buckets are also readable directly by every authenticated user | — | [web-ui.md](feature-threats/web-ui.md) |
