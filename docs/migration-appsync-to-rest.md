...
- **The dispatcher denies by default.** Before it routes anything, the dispatcher
  ...
  - ⚠️ **Restored for group-scoped operations only.** 15 of the 118 declared
    ...
    reachable by any authenticated caller. They are enumeration, platform and
    profile reads; 101 operations require a group, 11 of them via `ANY_GROUP`
