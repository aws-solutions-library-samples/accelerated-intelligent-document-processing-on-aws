...
Supporting data: `benchmarks/results/v0.6.5-fixed2-config-core/` (70-run grid),
`benchmarks/results/v0.6.5-fixed2-intconf-sonnet5/` (repeated-measures),
`security/test-results/0.6.5-verify/`.
