...
|---------|----------------|----------|------|---------|--------|
| **v0.6.8 (pre)** | v0.6.7 | flat (recall 1.000 = 1.000; scalar 1.000 on the unchanged docs) | mixed sign, all within spread (n=6) | **0 failures in 171 runs; every document now ONE section (#726 fixed). Simple mode's single-response limit re-exposed: 43/800 rows silently at 17 pages, FAIL from ~25 pages. Sizer A/B: batch 8 = −29% assessment cost.** | [v0.6.8.md](v0.6.8.md) |
