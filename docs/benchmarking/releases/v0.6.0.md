...
**Method:** a single stack (`IDPbench0516`, us-west-2) was
...
> `benchmarks/results/v0.5.16/corefast/` and `benchmarks/results/v0.6.0/corefast/`
...
# score + compare
AWS_PROFILE=default python3 benchmarks/harness/aggregate.py --run benchmarks/results/run-<stamp> --out benchmarks/results/<rel>/corefast
python3 benchmarks/harness/aggregate.py --compare benchmarks/results/v0.6.0/corefast/summary.json --baseline benchmarks/results/v0.5.16/corefast/summary.json
```
